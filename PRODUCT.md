...
- Email and Web Push notify the provider (Resend in production, Mailpit locally); no SMS. Google Calendar sync (Pro): confirmed bookings mirror into a chosen calendar, Busy time in ticked calendars blocks the booking page; Booklo stays the record (spec 2026-09-05).
