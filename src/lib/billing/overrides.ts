...
import { TEAM_INCLUDED_RESOURCES, type PaidPlanId } from "./plans";
...
/** The synthetic subscription an active comp behaves as: active, monthly (no
    price is charged, so the interval is cosmetic), Team's included resources
    (a comped Team org gets the full roster; a comped Pro org's limit is 1
