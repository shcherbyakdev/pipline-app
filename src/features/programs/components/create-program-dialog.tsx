  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className={dialogPanelClass}>
        <DialogBreadcrumbHeader chip={<DialogChip>Program</DialogChip>}>
          New program
        </DialogBreadcrumbHeader>
        {templates.length === 0 ? (
          <p className="text-muted-foreground px-5 pt-4 pb-6 text-sm">
            Programs are created from a template, and you don&apos;t have any
            yet.{" "}
