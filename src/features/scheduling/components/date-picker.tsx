...
const dayAriaFmt = new Intl.DateTimeFormat("en-GB", {
  weekday: "long",
  day: "numeric",
  month: "long",
  year: "numeric",
    ...
    <Popover open={open} onOpenChange={onOpenChange}>
      <PopoverTrigger
        render={
          ...
          >
            {value ? triggerFmt.format(utcDate(value)) : "Pick a date"}
          </button>
        }
      />
      <PopoverContent align="start" className="w-auto p-3">
        <div className="mb-2 flex items-center justify-between gap-2">
          <p className="pl-1 text-sm font-medium">{monthLabelFmt.format(utcDate(`${month}-01`))}</p>
            ...
            .map((date, i) =>
              date === null ? (
                ...
                <button
                  ...
                  aria-label={dayAriaFmt.format(utcDate(date))}
