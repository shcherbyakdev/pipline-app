...
/** A person's appointments, split around now — the shared detail-page read. */
export function listStaffBookings(staffId: string, now?: Date) {
  return listDetailBookings("staff_id", staffId, now);
}
