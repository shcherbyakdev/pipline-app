...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-foreground/10 duration-150 data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
        className,
      )}
      {...props}
    />
...
function DialogContent({
  ...
  /** Strengthen the scrim for takeover-sized dialogs (e.g. the template
      gallery) that sit over busy surfaces; the default stays the system's
      subtle ink dim. */
