...
export const LOCALE_NAMES: Record<Locale, string> = { en: "English", uk: "Українська", pl: "Polski" };
...
export const SWITCH_TO_LOCALE: Record<Locale, string> = { en: "Switch to English", uk: "Перейти на українську", pl: "Przełącz na polski" };
...
export const INTL_LOCALES: Record<Locale, string> = { en: "en-GB", uk: "uk", pl: "pl" };
...
/** Accept-Language → the best supported locale by q-value, matching on the
    ...
    default. Tiny on purpose: three locales do not need a matcher library. */
